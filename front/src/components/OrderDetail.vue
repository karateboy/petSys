    ...
    <div>
        <div class="ibox-content">
            <div class="form-horizontal">
                <div class="form-group"><label class="col-lg-1 control-label">客戶名稱:</label>
                ...
                <div class="form-group"><label class="col-lg-1 control-label">店名:</label>
                    ...
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-outline btn-primary dim"
                               ...
                               :class="{active: order.storeID==store._id}"
                               @click="order.storeID=store._id">
                            <input type="radio">{{ store.name }} </label>
                    </div>
                </div>
                <div class="form-group"><label class="col-lg-1 control-label">注意事項:</label>
                    ...
                    <div class="col-lg-7">
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-outline btn-primary dim"
                                   ...
                                   :class="{active: inWorkers(clerk._id) }">
                ...
                <div class="form-group">
                    <div v-if='isEmptyOrder' class="col-lg-offset-1">
                        <button class="btn btn-primary" :disabled="!readyForSubmit"
                                @click.prevent="upsertOrder">新增
                        </button>
                    </div>
                    <div v-else class="col-lg-offset-1">
                        <button class="btn btn-primary" :disabled="!readyForSubmit"
                                @click.prevent="upsertOrder">更新
                        </button>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        watch:{
          "order.storeID": function (newStoreID) {
